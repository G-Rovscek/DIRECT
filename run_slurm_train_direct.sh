#!/bin/sh
#SBATCH --job-name=train_direct           # the title of the job
#SBATCH --output=direct_train.log         # file to which logs are saved
...
# Run code
srun --nodes=1 --exclusive --gres=gpu:1 --ntasks=1 python3 train.py \
    --config=$CONFIG \
