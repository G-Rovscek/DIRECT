#!/bin/sh
#SBATCH --job-name=va_direct           # the title of the job
#SBATCH --output=direct_va.log         # file to which logs are saved
...
CONFIG="./configs/va_direct.yaml"

# Run code
srun --nodes=1 --exclusive --gres=gpu:1 --ntasks=1 python3 -m src.experiments.va \
    --test_config=$CONFIG \
