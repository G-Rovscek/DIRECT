#!/bin/sh
#SBATCH --job-name=test_direct           # the title of the job
#SBATCH --output=direct_test.log         # file to which logs are saved
...
CONFIG="./configs/test_direct.yaml"

# Run code
srun --nodes=1 --exclusive --gres=gpu:1 --ntasks=1 python3 eval.py \
    --test_config=$CONFIG \
